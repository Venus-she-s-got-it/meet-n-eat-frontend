...
if (categories) {
    return (
        <Card  style={{ padding:'5%', marginBottom:'5%', fontSize:'70%', display:'flex', justifyContent:'center', alignItems:'center' }} className="fluid">
                                    <button style={{ float:'right' }}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-heart" viewBox="0 0 16 16">
                ...
                <Row>
                    <Col>
                        <Container style={{ textAlign:'center', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center'}} className="ml-1">
                            <Image 
                                style={{ borderRadius:'10px', border:'3px solid black', marginBottom:'5%'}}
                                src={image_url}
