...
const RestaurantCard = ({ restaurant }) => {
    const { darkColor, mediumColor, lightColor }  = useContext(UrlContext)
    ...
    if (categories) {
        return (
            <Card style={{marginBottom:'5%', fontSize:'70%', display:'flex', flexWrap:'wrap', justifyContent:'center', alignItems:'center', width:'40%', border:`1px solid ${darkColor}`, margin:'1%'}} className="fluid">
                <div style={{width:'100%'}}>
                    <button style={{ float:'right', width:'100%', color:'#D6300F', borderColor:'#D6300F', width:'10%', borderRadius:'10px', padding:'1%', backgroundColor:'white', border:'none'}}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-heart" viewBox="0 0 16 16">
